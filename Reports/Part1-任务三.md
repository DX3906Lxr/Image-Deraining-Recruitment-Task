...
这样网络就短了很多
如图所示
![alt text](<截屏2025-10-10 20.49.32.png>)
...
但现在不逐步学
现在我用不同尺度卷积核分别去各种的尺度上进行学习，然后再“融合”
或者说
...
### 2.2 DerainDataset
#### 1.根据模式生成对应文件夹路径
![alt text](<截屏2025-10-11 15.05.43.png>)
用join（）进行拼接😋
...
![alt text](<截屏2025-10-11 15.40.43.png>)
...
然后打开图像并转成RGB
最后应用transform预处理再返回
![alt text](<截屏2025-10-11 15.42.52.png>)
...
不妨来对比一下😋
##### 定位区别
![alt text](<截屏2025-10-11 15.51.33.png>)
##### 一对一配对
去雨、去噪、超分辨率等任务中，我们不是要输出一个“标签”
而是要从“输入图像”生成另一个“目标图像”
ImageFolder无法表达这种一对一关系，
所以就手动实现
##### 灵活性
...
```
![alt text](<截屏2025-10-11 19.34.47.png>)
- 限制像素范围 [0,1]
```
